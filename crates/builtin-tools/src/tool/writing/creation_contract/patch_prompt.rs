...
剧情规划初始包只输出 2 个 volumes 和从第 1 章起连续编号的 3 个 near_chapters；近期章节只是开篇窗口，不得提前完成全书终局、主冲突总解决或主角弧线终点，第三章必须留下明确后续主线债务。每卷 objective 与 ending_change、每章 goal 与 expected_turn 必须分别描述目标和不可逆变化。\n\
