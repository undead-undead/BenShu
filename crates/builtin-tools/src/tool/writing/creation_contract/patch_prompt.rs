...
主角必须在现有欲望、恐惧、底线、弧线起点和弧线终点中体现一个与题材、主线相符的内在张力或反差；不得新增“主角反差”字段，不得为追求反差强套扳猪吃虎、马甲或黑化等特定类型模板。\n\
...
读者承诺必须由已有主角欲望、恐惧、底线、弧线张力与主线因果推导，并落在现有 reader_promise 字段；不得新建反差、情绪标签或平台模板字段。\n\n\
稳定锚点：\n{stable_anchor}\n\n\
当前质量门缺口：{issue_focus}\n\n\
用户最新要求：{}\n\n\
硬性数值：target_units={exact_total_units}; chapter_unit_target={exact_chapter_unit}; expected_chapters={expected_chapters}。\n\
