...
impl MaintenanceManager {
    ...
    pub fn start_memory_cleanup(&mut self, memory: Arc<dyn Prunable>, config: MaintenanceConfig) {
    ...
    pub async fn shutdown(self) {
        info!(
            "Shutting down {} background maintenance tasks",
            self.tasks.len()
        );
